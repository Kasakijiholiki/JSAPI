...
exports.createseller = (req, res) => {
    try {
        ...
        const { seller_name, seller_age, seller_job, seller_phone, seller_address } = req.body
        ...
        dbcon.query(`insert into tbseller(seller_name,seller_age,
            ...
            seller_job, seller_phone, seller_address], (error, result) => {
                ...
                if (error) res.send("You have error to create seller")
                    ...
                    //get seller max id
                    dbcon.query(`select max(seller_id) as seller_maxid from tbseller`, (error, data) => {

                        if (error) res.send("error" + error)

                        const data1 = data[0]
                        seller_id = data1.seller_maxid
                    })
